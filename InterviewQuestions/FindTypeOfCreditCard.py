...
def cc_type(cc_number):
    ...
    # d = { 'amex': amex, 'discover':discover, 'visa': visa, 'mastercard':mastercard}
    ...
    for vals in d:
        type, rx = vals[0], vals[1]
        if rx.match(str(cc_number)):
            return type

    return -1

print (cc_type(5570735810881011)) #mastercard
print (cc_type(4024007141696)) #visa
print (cc_type(4716182333661786)) # visa
print (cc_type(371576372960229)) #amex
print (cc_type(6011350169121566)) #discover